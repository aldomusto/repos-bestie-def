...
public class TamaUtils extends TamaBase{
	...
	private static void leggiSazieta(TamaBase tama) {
		int _sazieta = InputDati
				.leggiIntero(String.format("Inserisci il valore intero di sazieta' iniziale (da %d a %d) : ",
						MINIMO_VALORI, MASSIMO_VALORI), MINIMO_VALORI, MASSIMO_VALORI);
		tama.sazieta = _sazieta;
	}

	private static void leggiSoddisfazione(TamaBase tama) {
		int _soddisfazione = InputDati
				.leggiIntero(String.format("Inserisci il valore intero di soddisfazione iniziale (da %d a %d) : ",
						MINIMO_VALORI, MASSIMO_VALORI), MINIMO_VALORI, MASSIMO_VALORI);
